...
export default function FilterIcon({ size = 20 }: { size?: number }) {
  ...
  return (
    <Box
      sx={{
        ...
        color: theme.palette.text.secondary, // ← универсальный серый под тему
      }}
    >
      <svg
        width={size}
        height={size}
        viewBox="0 0 32 32"
        fill="currentColor" // ← цвет берётся из Box color
